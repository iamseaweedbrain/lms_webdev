<x-layouts.landinglayout>
    ...
    <section class="flex flex-col items-center justify-center min-h-[80vh] space-y-6">
        ...
        <form action="{{ route('storeSignUp') }}" method="POST" class="flex flex-col space-y-4 w-80">
            @csrf
            <input type="text" name="firstname" placeholder="Enter First Name" class="rounded-full bg-gray-200 px-4 py-2 focus:outline-none">
            <input type="text" name="lastname" placeholder="Enter Last Name" class="rounded-full bg-gray-200 px-4 py-2 focus:outline-none">
            <input type="email" name="email" placeholder="Enter Email" class="rounded-full bg-gray-200 px-4 py-2 focus:outline-none">
            <input type="password" name="password" placeholder="Enter Password" class="rounded-full bg-gray-200 px-4 py-2 focus:outline-none">
            <input type="password" name="password_confirmation" placeholder="Re-enter Password" class="rounded-full bg-gray-200 px-4 py-2 focus:outline-none">
